      ...
      <section
        ...
        <Paper elevation={13} className={classes.paper}>
          <Typography variant="h2" className={classes.heading}>
            Join Dangote as a Staff
          </Typography>
          <div className={classes.formContainer}>
            <Typography variant="h5" style={{ textAlign: 'center' }}>
              You were invited to join the Fresible Jureb account as a Staff.
              Fill in your details below to gain access
            </Typography>
            <div>
              ...
              <div className={classes.gridForm}>
                <div style={{ padding: '.4rem 0' }}>
                  <FormControl fullWidth>
                    ...
                    <SelectComp
                      ...
                      handleSelectChange={handleSelectChange('maritalStatus')}
                      value={values.data.maritalStatus}
                      menuItem={[
                ...
                <FormControl fullWidth style={{ padding: '.4rem 0' }}>
                  <Typography variant="h6">
                    Select Bank
                    <span
                      style={{
                  ...
                  <SelectComp
                    label="Bank"
                    handleSelectChange={handleSelectChange('bank')}
                    value={values.data.bank}
                    menuItem={[
                      ...
                      { label: 'Microfinance Bank', value: 'microfinance' },
                    ]}
                  />
                </FormControl>
                <FormControl fullWidth>
            ...
            <span style={{ textAlign: 'center' }}>
              <Typography variant="h6" style={{ padding: '.6rem 0rem' }}>
                ...
                <a
                  ...
                  style={{ textDecoration: 'none', margin: '0rem .3rem' }}>

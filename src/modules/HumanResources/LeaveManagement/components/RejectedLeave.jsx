...
import leaveActions from 'redux/actions/leaveActions';

const { fetchLeaveDataRejected } = leaveActions;
...
export default function Rejectedleave() {
  ...
  useEffect(() => {
    ...
    authClient
      .get(
        `/api/v1/employee/leave/management/fetch?page=1&limit=20&leaveStatus=REJECT&issuersId=${
        ...
        {isLoading ? (
                    ...
                    {columns.map((column) => {
                      ...
                      return (
                        <TableCell
                          ...
                          onClick={() => (
                            dispatch(
                              fetchLeaveDataRejected(row.employeeId, setErrors),
                            ),
                            history.push(
          ...
          <div className={classes.recordWrapper}>
            <Typography variant="h6" className={classes.noRecord}>
              No Rejected leave at the moment
            </Typography>
          </div>
        )}
      </div>

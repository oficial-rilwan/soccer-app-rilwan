...
export const DeleteDialog = ({
  ...
  const handleDelete = () => {
    authClient
      .delete(`api/v1/accounting/transaction/bulk/delete`, {
    ...
    <Dialog
      ...
      <DialogContent dividers>
        <Typography gutterBottom className={classes.dialogContent}>
          You can't delete this {headerText} because there are transactions tied
          to it . To delete it, erase all transactions linked to the products
        </Typography>
        <div
          style={{
            display: 'flex',

...
const columns = [
  ...
  { id: 'amount', label: 'Qty', minWidth: 120 },
  { id: 'amount', label: 'Rate', minWidth: 120 },
  { id: 'action', label: ' Tax', minWidth: 120 },
];
  ...
  return (
    <div>
              ...
              <GridContainer>
                <GridItem
                  ...
                  <SelectComp
                    label="Unit"
                    menuItem={[
                      { label: 'Cash and Bank', value: 'Cash and Bank' },
                    ]}
                    input={<SelectInput />}
                  />
                </GridItem>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
        <GridItem xs={12} sm={4}>
          <div className={classes.computationBox}>
            <div className={classes.computationItem}>
              <p>Subtotal:</p>
              <p>NGN200,000.00</p>
            </div>
            <div className={classes.computationItem}>
